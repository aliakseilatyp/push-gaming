...
import { statusJackpotTierInstanceColor, statusJackpotsColor } from 'constants/colors';
            ...
            {selectedStatus.map((status) => {
              return (
                <StatusChip
                  ...
                  sx={{ color: statusJackpotsColor[status] || statusJackpotTierInstanceColor[status] }}
                />
              );
            })}
          </Stack>
